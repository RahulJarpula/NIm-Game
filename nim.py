...
class NimAI():
    ...
    def get_q_value(self, state, action):
        ...
        return self.q[state_action_pair] if state_action_pair in self.q else 0        
    ...
    def update_q_value(self, state, action, old_q, reward, future_rewards):
        ...
        self.q[state_action_pair] = new_q_value
    ...
    def best_future_reward(self, state):
        ...
        if not available_actions:
            return 0
        max_q_value = max(self.get_q_value(tuple(state), action) for action in available_actions)
